  ...
  render() {
    ...
    return (
      <>
        ...
        <ImageWithText imageLeft imageFull className="taylor-member" memberName="Taylor Zanke" memberTitle="Graphic Designer" description="Taylor is a designer passionate about doing work that matters. With a background in Architecture and Graphic Design, he brings a rigorous yet flexible process to every project. He creates clean visual design and thoughtful UX."/>
