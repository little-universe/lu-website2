  ...
  render() {
    ...
    return (
      <>
        ...
        <FeaturedText textWithCardRight className="" status="Ongoing Partnership" list={["Digital Product", "UX/UI", "Branding", "Strategy", "Front End Development", "Back End Development"]} projectType="Advocacy" projectTitle="Motivote" text="Motivote is a digital platform built by a former student organizer and non-voter which gets millenials to vote by offering incentives. By creating a seamless digital experience on a product which can be whitelabeled to fit partnership goals, we bridge the gap between intention and action for young voters." dominantColor="lightGrey" ctaLabel="Strive Digital"/>
