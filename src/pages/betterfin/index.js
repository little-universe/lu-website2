  ...
  render() {
    ...
    return (
      <>
          ...
          <FeaturedText textForProductImageLeft className="betterfin-1" header="Hello Small Business" text="Betterfin exchanges data for value, and their onboarding flow captures that data in a clean and efficient manner." dominantColor="lightGrey"/>
