    ...
    return (
      ...
      <Transporter name="caseStudy6" show={true} duration={500} properties={[]}>
        ...
        <Fade bottom distance="30px" duration={500}>
            ...
            <WorkImageLeft image={require("../../assets/projects/instructrr/instructrr-1.png")} headline="Voting Is A Conversation" description="One of the principle ideas with the Vote Crew dashboard was to incentivize use through engaging people across action types. Even small actions were included in a news feed, visible by all members of the group, alongside larger actions."/>
            ...
            <WorkImageRight image={require("../../assets/projects/instructrr/instructrr-2.png")} headline="Leaderboard Metrics" description="Typically a leaderboard is organized as a function of points, but with Vote Crew the leaderboard was organized based on actions taken by the users. Rather than abstracting behavior into points, this context called for a more direct approach. "/>
            <WorkImageLeft image={require("../../assets/projects/instructrr/instructrr-3.png")} headline="Voting Is A Conversation" description="One of the principle ideas with the Vote Crew dashboard was to incentivize use through engaging people across action types. Even small actions were included in a news feed, visible by all members of the group, alongside larger actions."/>
