...
class Outraise extends Component {
  ...
  render() {
    ...
    return (
      ...
      <FeaturedText textForProductImageLeft className="outraise-1" header="All Event Details In One Spot" text="A single page with a unique URL makes sharing the event with friends easy and straightforward. We designed a clean event detail page which balanced graphical content and informational content. Using strong typography and building clarity through strong colors allowed us to present a simple and clearn page." dominantColor="lightBlue"/>
      <FeaturedText textForProductImageRight className="outraise-2" header="RSVP Made Easy As Pie" text="RSVPing to an event from your friend is a single screen, single CTA affiar. We designed a clean UI for collecting the necessary data from the user and stripped away distractions." dominantColor="darkBlue"/>
