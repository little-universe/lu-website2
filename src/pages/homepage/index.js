        ...
        <FeaturedText textBigStatement text="There is no recipe for change."/>
          ...
          <Grid container className="section-body">
            <Grid item md={4} className="service-card">
              ...
              <div className="card-expanded">We do it all. Design, Development, Data, and everything in between.</div>
            </Grid>
            <Grid item md={4} className="service-card">
              <div className="card-header">Strategy</div>
              <div className="card-expanded">Getting you from A to B, but thinking about Z.</div>
            </Grid>
            <Grid item md={4} className="service-card">
              <div className="card-header">Impact</div>
              <div className="card-expanded">We define metrics for success, paint a picture of what that looks like, and execute.</div>
            </Grid>
          </Grid>
        </Grid>
        <Footer/>
