...
=======
          ...
          <ApproachImageLeft className="" headline="A Technical Foundation" description="We're experts in design and engineering and are always searching for ways to improve. In the face of evolving markets or social contexts we stay anchored to our understanding of the fundamental principals of design and engineering as ways of seeing the world. Our ability to return to well learned foundations helps us weather rocky seas." image={require("../../assets/office/desk.jpg")}/>
>>>>>>> 2a4a3b6c32a8ededbb05d822cfb7a82b7e8df328
          ...
          <ApproachImageLeft className="" headline="Our Effort in Intention" description="We cultivate relationships with the people we work with, internally and externally. We make a conscious effort to be present and clear with how we collaborate. We believe that great work comes from systems of support and connection. We're always seeking to expand our practice of intentionality and hope to work with clients who share this outlook." image={require("../../assets/office/intention.jpg")}/>
          <ApproachImageRight className="" headline="Trusting Partnerships" description="We make a concerted effort to be trusting and earn trust across all our work. It is important to us to work with people who we consider partners and those who we can prove our commitment to. We listen and thoughtfully respond as much as we conceptualize, design, and implement." image={require("../../assets/office/office.jpg")}/>
