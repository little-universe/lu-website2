    ...
    return (
      <>
        ...
        <div className="content-container">
          <ApproachStatement className="" title="We Love Product" paragraph="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. "/>
          ...
          <div className="articles-section">
            ...
            <ApproachArticle title={["Motion JS", ""]} paragraph="Motion JS is a React library which helps designers and developers retain user context in web applications and in other web domains, structuring keyframes and transitions around key objects and durations."/>
            <div className="medium-cta">
              <p>Check out our Medium</p>
            </div>
          </div>
          <ApproachStatement className="" title="We Love Product" paragraph="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. "/>
        </div>
