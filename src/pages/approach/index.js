...
class Approach extends Component {
  ...
  render() {
    ...
    return (
      <>
      <Transporter name="approachText" show={true} duration={500} properties={[]}>
        <Hero heroText className="approach-hero" headline="We Build Trust To Deliver Progress"/>
      </Transporter>
