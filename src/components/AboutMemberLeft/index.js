            ...
            <div className="content-container" style={style}>
                {image, name, title, description &&
                    <div classname="container">
                        <Grid className={`member-image-left ${className}`} container justify="center" alignItems="center">
                          <Grid container justify="center" alignItems="flex-start">
                            <Grid item md={6} xs={12} className="member-image"><img src={image} /></Grid>
                            <Grid item md={6} xs={12} className="member-image-text" justify="center" alignItems="center">
                            {anim !== "showing" &&
